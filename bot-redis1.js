...
function tweet() {
  ...
  request(url, function(error, response, html) {
    if (!error && response.statusCode == 200) {
      ...
      //return;
      client.get("tweeted_fn", function (err1, reply1) {
        if (!reply1) {
          client.set("tweeted_fn", dates[0], function(err2,reply2) {
            client.set("tweeted2_fn", '', function(err3, reply3) {
          ...
          console.log(reply1.toString());
          client.get("tweeted_fn", function(err4, reply4) {
            if (err4) throw err4;

            var data = reply4.toString();
            client.get("tweeted2_fn", function(err5, reply5) {
              var data2 = reply5.toString();
              ...
              if (new_date) {
                ...
                if (err5) throw err5;
                  ...
                  if (tweetPrev) {
                    ...
                    client.set("tweeted2_fn", data2, function(err6,reply6) {
                  ...
                  client.set("tweeted_fn", data, function(err7,reply7) {
                ...
                if (tweetToday) {
                    ...
                    client.set("tweeted2_fn", data2, function(err8,reply8) {
